...
<body>
	...
	<div id="header">
		<div id="site_title">
			<a href="#">Technology Blog - Free CSS Template</a>
		</div>
		<div id="header_right">
			<a href="#"><img alt="" src="images/twitter.png" /></a><a href="#"><img alt="" src="images/rss.png" /></a>
			<div id="login_box">
		...
		<div id="content">
			...
			<div class="post_box">
				<div class="header">
					...
					<div class="tag">
						<strong>Tags:</strong> <a href="#">Photography</a>, <a href="#">Free Photos</a>, <a href="#">HDR</a>
					</div>
			...
			<div class="post_box">
				<div class="header">
					<h2>
						<a href="#">Quisque dictum pharetra neque</a>
					</h2>
					<div class="tag">
						<strong>Tags:</strong> <a href="#">Photography</a>, <a href="#">Free Photos</a>, <a href="#">Royalty</a>
					</div>
					<span class="posted_date">25 Feb <strong>2010</strong>
					</span>
				</div>
			...
			<div class="post_box">
				<div class="header">
					...
					<div class="tag">
						<strong>Tags:</strong> <a href="#">Flash</a>, <a href="#">Free Files</a>, <a href="#">AS3</a>
					</div>
					<span class="posted_date">25 Feb <strong>2010</strong>
					</span>
				</div>
			...
			<div class="post_box pb_last">
				<div class="header">
					<h2>
						<a href="#">Mauris quis nulla sed ipsum pretium sagittis</a>
					</h2>
					<div class="tag">
						<strong>Tags:</strong> <a href="#">HTML</a>, <a href="#">Free Templates</a>, <a href="#">CSS</a>
					</div>
					<span class="posted_date">25 Feb <strong>2010</strong>
					</span>
				</div>
			...
			<div class="sidebar_box">
				...
				<div class="sb_content">
					<ul class="sidebar_menu">
						...
						<li><a href="#">Web Design Tips</a></li>
						<li><a href="#">Flash XML Galleries</a></li>
						<li><a href="#">Inspiring Flash Websites</a></li>
					</ul>
				</div>
			</div>
		</div>
	...
	<div id="bottom">
		<div class="bottom_box">
			...
			<a class="continue" href="#">more info</a>
		</div>
		<div class="bottom_box">
			<h5>
